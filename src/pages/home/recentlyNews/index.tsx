        ...
        <SwiperSlide>
          <div className="max-w-[689px] relative">
            ...
            <div>
              ...
              <p className="text-[19px] text-third max-w-[430px] mt-6">
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever.
              </p>
              <a href="#" className="font-normal uppercase underline text-primary text-[19px] mt-9">Batafsil</a>
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <div className="max-w-[689px] relative">
            ...
            <div>
              ...
              <a href="#" className="font-normal uppercase underline text-primary text-[19px] pt-9">Batafsil</a>
            </div>
          </div>
        </SwiperSlide>
      </Swiper>
